...
<table>
<input type="hidden" name="id" value="<?php echo $reply_alarm['id']; ?>" />
<tr><td width="80px">违规原因：</td><td><input type="text" name="reason" style="width:300px;" value="<?php echo $reply_alarm['reason'] ?>" /></td></tr>
<tr><td>状态：</td><td>
<?php 
if($reply_alarm["status"]=='0'){
?>
...
<input type="submit" value="确认审查" name="reply_alarm" class="btn btn-primary" />
<a class="btn" href="reply_alarm_mag.php">返回</a>
</td></tr>
</table>
</form>
</div>
